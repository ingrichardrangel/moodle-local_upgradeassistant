...
class checklist_completed extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventchecklistcompleted', 'local_upgradeassistant');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' completed upgrade assistant checklist item '{$this->objectid}'.";
    }
